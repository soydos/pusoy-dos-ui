...
const Privacy = () => {
  return (<div>
    ...
    The policy: This privacy policy is for this website; <strong>soydos.com</strong> 
    and served by soydos.com and governs the privacy of its users who choose to use it.
    It explains how we comply with the GDPR (General Data Protection Regulation), 
    the DPA (Data Protection Act) [pre GDPR enforcement] and the PECR 
    ...
    <br/>
    <h4>External Website Links & Third Parties</h4>
    ...
    <br/>
    <h4>Social Media Policy & Usage</h4>
    There may be instances where our website features social sharing buttons, which help share web content directly from web pages to the respective social media platforms. You use social sharing buttons at your own discretion and accept that doing so may publish content to your social media profile feed or page.
    <br/>
    <em>v.3.0 March 2018 Edited & customised by: Ben Brunton</em>
  </div>);
};
